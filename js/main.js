...
$(document).ready(function() {
  ...
  if($('ul#flickr-badge').length) {
    ...
    itemTemplate: '<li><div class="flickr-container"><a href="http://www.flickr.com/photos/56342020%40N03"><span><img src="{{image_m}}" alt="{{title}}" /></span></a></div></li>'
    });
  };
  ...
  $('.twitter-carousel').tweet({
    ...
    template: "<i class='fa fa-twitter twitt'></i><p><a class='cp-color' href='_257buser_url_257d.UNKNOWN'>@{screen_name}</a>{join}{text}<br>{time}</p>"
  });
  ...
  $('.twitter-1').tweet({
    ...
    count: 8,
    loading_text: 'loading twitter feed...',
    template: "<i class='fa fa-twitter twitt'></i><div class='divider-mini'></div><p><a class='cp-color' href='_257buser_url_257d.UNKNOWN'>@{screen_name}</a>{join}{text}<br>{time}</p>"
  });
